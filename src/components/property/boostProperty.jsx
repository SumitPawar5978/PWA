...
import { userBoostProperty } from "@/src/utils/axios";
const style = {
  position: "absolute",
  top: "50%",
  left: "50%",
...
const BoostProperty = ({property_id}) => {
  ...
  const handlePropertyLog = async (id) => {
    ...
    try {
      let res = await userBoostProperty(id);
      Toast.fire({
            icon: 'success',
      ...
      >
        <Box sx={style}>
          ...
          <Typography
            ...
            pb={1}
          >
       Do you want to boost the property?
          </Typography>
          <Typography
            textAlign={"center"}
            component={"p"}
